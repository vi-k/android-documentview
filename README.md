...
docView.document.characterStyle
        .setSize(Size.em(1.2f)) // Наверху обязательно должен быть указан абсолютный,
                                ...
                                // размер шрифта по-умолчанию равным 16sp.
...
Базовые линии рассчитываются автоматически по максимальным размерам задействованных в строке символов с учётом их смещений относительно базовой линии (`baselineShift`), также как это происходит с HTML:
