...
Интерлиньяж `leading = Size.ratio(1f)` для первой строки не работает! Хотя, если принудительно установить первую базовую строку на начало секции, можно получить ожидаемую синхронизацию:
