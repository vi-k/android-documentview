...
Строки получились одинакового размера, но слово "laboris" и сноска "\*" чудом не пересекаются со строкой выше, а числам повезло, что знаки снизу не имеют диакритических знаков. Но если чудо и везение запланированы, то почему бы и нет!
